...
async def generate_itinerary(
    *,
    ...
    await _persist_agent_result(
        ...
        input_payload={"trip": trip.model_dump()},
        output_payload=planner_result.data.model_dump(),
    ...
    await _persist_agent_result(
        ...
        input_payload={"trip": trip.model_dump()},
        output_payload=weather_result.data.model_dump(),
    ...
    await _persist_agent_result(
        ...
        input_payload={"trip": trip.model_dump()},
        output_payload=attractions_result.data.model_dump(),
    ...
    await _persist_agent_result(
        ...
        input_payload={
            ...
            "planner": planner_result.data.model_dump(),
            "weather": weather_result.data.model_dump(),
        },
        output_payload=scheduler_result.data.model_dump(),
    ...
    await _persist_agent_result(
        ...
        input_payload={
            "trip": trip.model_dump(),
            "schedule": scheduler_result.data.model_dump(),
        },
        output_payload=food_result.data.model_dump(),
    ...
    await _persist_agent_result(
        ...
        input_payload={
            "trip": trip.model_dump(),
            "schedule": scheduler_result.data.model_dump(),
            "meals": food_result.data.model_dump(),
        },
        output_payload=budget_result.data.model_dump(),
    ...
    await _persist_agent_result(
        ...
        input_payload={"trip": trip.model_dump(), "schedule": scheduler_result.data.model_dump()},
        output_payload=validator_result.data.model_dump(),
